        ...
        <div>
            ...
            <div className='px-10'>
                <div className='flex items-center justify-center'>
                    <img src={call} className='w-10 lg:w-12 mr-3' alt='Phone Number'></img>
                    <p className='text-lg lg:text-xl'>+8801833558017</p>
                </div>
                <div className='flex items-center justify-center mt-5'>
                    <img src={gmail} className='w-10 lg:w-12 mr-3' alt='Email Address'></img>
                    <p className='text-lg lg:text-xl'>mdripon8869@gmail.com</p>
                </div>
                <div className='flex items-center justify-center mt-5'>
                    <img src={locate} className='w-10 lg:w-12 mr-3' alt='Location'></img>
